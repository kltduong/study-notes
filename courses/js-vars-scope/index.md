...
Start with `variable-lifecycle.md` — it introduces the 3-stage model that everything else references. Then `execution-context.md` for the spec structures that make those stages concrete. Subsequent notes build on both.
